...
import co.com.datacredito.services.schema.serviciolocalizacion.v1.ConsultarDatosLocalizacion.Solicitud;
import co.com.datacredito.services.schema.serviciolocalizacion.v1.ConsultarDatosLocalizacion.Solicitud.SolicitudDatosLocalizacion;
 ...
 * @author john
 */
public class Cliente_DataCredito_Reconocer {

    private JaxWsProxyFactoryBean factory;

    public static void main(String args[]) {
        System.out.println(new Cliente_DataCredito_Reconocer().getLocalizacion());
    }
    ...
    public String getLocalizacion() {
        ...
        try {
           ...
           System.setProperty("org.apache.cxf.stax.allowInsecureParser", "1");
            ...
            factory.setAddress("https://demo-servicesesb.datacredito.com.co/wss/localizacion/services/ServicioLocalizacion?WSDL"); //Endpoint del servicio
            ...
            SolicitudDatosLocalizacion solicitudLoca = new SolicitudDatosLocalizacion();
            ...
            return _consultarDatosLocalizacion__return.getConsultarDatosLocalizacionReturn();
        } catch (Exception e) {
